...
angular.module('angularCharts').directive('acChart', [
   ...
   */
     ...
     */
      ...
      */
        if (config.lineLegend === 'lineEnd') {
          ...
          }).style("font-size", "xx-small").attr('transform', function (d) {
     ...
     */
      function pieChart() {
          console.log("starting pie chart function");
...
angular.module("right", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("right",
    ...
    "\n" +
    "<div class='ac-title' style='font-weight: bold;font-size: 1.2em;'>{{acConfig.title}}</div>\n" +
    "<div class='ac-chart' style='float:left;width:85%;'>\n" +
    "</div>\n" +
    "<div class='ac-legend' style='float:left; max-width:15%;' ng-show='{{acConfig.legend.display}}'>\n" +
    " <table style='list-style:none;margin:0px;padding:0px;'>\n" +
    " <tr ng-repeat=\"l in legends | limitTo:yMaxData\">\n" +
    "   <td><div ng-attr-style='background:{{l.color}}; height:10px;width:10px;'></div></td>\n" +
    "   <td style=' display: inline-block;font-size: x-small' ng-bind='l.title'></td>\n" +
    " </tr>\n" +
    " </table>\n" +
    "</div>");
}]);
